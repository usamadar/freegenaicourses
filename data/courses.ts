...
const beginnerCourses: Course[] = [
  ...
  },
  {
    ...
    level: "Beginner",
    category: "Specialized",
    description: "An introductory course exploring the intersection of big data, AI, and ethical issues. It provides context on how the digital data explosion creates unprecedented opportunities for insight, while raising serious ethical questions. Students learn about the promises and limitations of big data and machine learning, and why ethical considerations like privacy, bias, and consent are crucial when leveraging AI on human data. Hands-on labs include using IBM Watson's AI services and experimenting with Google's Teachable Machine. The course challenges learners to think critically about the social implications of AI.",
...
const intermediateCourses: Course[] = [
  ...
  },
  {
    ...
    level: "Intermediate",
    category: "Systems",
    description: "A practitioner-focused short course on operationalizing LLMs in real-world applications. Developed in collaboration with Google Cloud and taught by an ML engineer at Google, it walks through the end-to-end LLMOps pipeline: from preparing and versioning training data, to performing supervised fine-tuning of a model, deploying the customized LLM, and monitoring it for safety. Learners get hands-on experience with tools like BigQuery (for data preprocessing), Kubeflow Pipelines (for automation), and techniques for responsible AI (safety score monitoring). By course end, you'll know how to train and deploy a domain-specific LLM and manage it in production.",
...
const advancedCourses: Course[] = [
  ...
  },
  {
    ...
    level: "Advanced",
    category: "Systems",
    description: "An advanced course that teaches how to build and deploy real-world AI products, covering the full stack of machine learning in production. Originally run as an intensive bootcamp at UC Berkeley, its materials (lectures, labs) are freely available. The curriculum spans the entire ML lifecycle: defining a problem, selecting and training models, managing data and experiments, deploying models as services, and maintaining/monitoring them in production. It emphasizes industry best practices and toolchains (from experiment tracking to CI/CD for ML) and features instructors and guest lectures from leading AI organizations. By the end, you'll understand how to take a complex model from research to a scalable, reliable application in production.",
